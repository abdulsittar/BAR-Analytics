function d3PieChart(dataset, datasetBarChart){
   ...
   color = d3.scale.ordinal(d3.schemeAccent); //color scheme
   ...
   const data = d3.layout.pie()   //Creating the data object that will develop the various segment of the pie chart.
       .sort(null)
